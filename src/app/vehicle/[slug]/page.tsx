...
export default function VehicleDetailPage({ params }: Props) {
  ...
  return (
    <main className="bg-[#0A0A0A] min-h-screen">
      ...
      {/* ─── VEHICLE HERO ─── */}
      <section className="relative h-screen overflow-hidden flex flex-col items-center justify-start pt-[120px]">
        {/* Showroom background */}
        ...
        <div className="relative z-10 text-center w-full">
          ...
          <h1 className="font-serif text-[clamp(72px,10vw,130px)] font-light tracking-[8px] uppercase leading-none text-[#F5F0E8] mb-12">
            {car.model}
          </h1>
            ...
            {[
              ...
              <div key={label} className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-[20px] font-semibold text-[#F5F0E8] tracking-[1px] leading-none">
                    {value}
                  </p>
                  <p className="text-[9px] tracking-[2px] text-[#9A9080] uppercase mt-0.5">
                    {label}
                  </p>
                </div>
              </div>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex z-10">
          <button className="flex items-center gap-3 bg-black/60 backdrop-blur-sm border border-[rgba(201,168,76,0.3)] px-10 py-4 text-[10px] tracking-[2px] text-[#F5F0E8] uppercase font-medium hover:bg-[rgba(201,168,76,0.12)] hover:border-[#C9A84C] transition-all cursor-pointer font-sans">
          ...
          <button
            ...
            className="flex items-center gap-3 bg-[#C9A84C] border border-[#C9A84C] px-10 py-4 text-[10px] tracking-[2px] text-black uppercase font-bold hover:bg-[#E8C97A] transition-all cursor-pointer font-sans"
          >
            <svg className="w-5 h-5 stroke-black" fill="none" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      <section className="relative bg-[#0A0A0A]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-12 py-24 grid grid-cols-2 gap-16 items-center">
          {/* Description */}
          <div>
            ...
            <h2 className="font-serif text-[48px] font-light tracking-[3px] uppercase text-[#F5F0E8] leading-none mb-6">
              {car.model}
            </h2>
            ...
            <div className="mt-8 flex gap-3">
              ...
              <Link
                href="/flotte"
                className="border border-[rgba(201,168,76,0.3)] text-[#9A9080] px-8 py-3 text-[10px] tracking-[2.5px] font-medium uppercase hover:border-[#C9A84C] hover:text-[#C9A84C] transition-colors no-underline font-sans"
              >
                Retour flotte
              </Link>
            </div>
        ...
        {/* Other vehicles */}
        <div className="relative z-10 border-t border-[rgba(201,168,76,0.12)] px-12 py-12">
          ...
          <div className="grid grid-cols-3 gap-2 max-w-4xl mx-auto">
            {otherCars.slice(0, 3).map((other) => (
              <Link
                ...
                className="relative overflow-hidden block no-underline group h-36"
              >
                <Image
